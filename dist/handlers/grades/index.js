...
var _listWithSubjects = require("./list-with-subjects");

const router = (0, _express.Router)();
exports.router = router;
router.get("/subjects", _auth.auth, (req, res, next) => (0, _listWithSubjects.listWithSubjects)(req.query).then(data => res.json(data)).catch(next));
